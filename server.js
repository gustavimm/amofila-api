...
function carregarEstado() {
  try {
    if (fs.existsSync(ARQUIVO_ESTADO)) {
      const raw = fs.readFileSync(ARQUIVO_ESTADO, 'utf8');
...
// Garante que chave "fora" existe mesmo em estados salvos antigos
...
function getChaveEscala(horaReal) {
  ...
  // Fora do expediente (antes das 8h ou depois das 18h)
  return "fora";
}
